            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'label' => 'Penerimaan Uang Muka Customer',
                        'type' => 'inflow',
                        'resolver' => 'customerDeposits',
                        'include_assets' => false,
                        'sort_order' => 2,
                        'prefixes' => [],
                        'asset_prefixes' => [],
                        'sources' => ['Uang Muka Penjualan', 'Deposit Customer'],
                    ],
                    [
                    ...
                    [
                        'key' => 'supplier_deposits',
                        'label' => 'Pembayaran Uang Muka Supplier',
                        'type' => 'outflow',
                        'resolver' => 'supplierDeposits',
                        'include_assets' => false,
                        'sort_order' => 5,
                        'prefixes' => [],
                        'asset_prefixes' => [],
                        'sources' => ['Uang Muka Pembelian', 'Deposit Supplier'],
                    ],
                    [
