...
it('provides purchase order inline item operations and navigator UI', function () {
    ...
    expect($view)
        ...
        ->toContain('Klik Simpan Perubahan Item agar masuk ke total/summary.')
        ->toContain('Tidak ada perubahan item. Ubah qty/harga/diskon/pajak jika ingin menyimpan perubahan item.')
