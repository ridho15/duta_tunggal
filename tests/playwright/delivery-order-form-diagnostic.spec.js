...
test.describe('Delivery Order Form Diagnostic', () => {
  test('inspect delivery order create form', async ({ page }) => {
    // Login first
    ...
    await page.screenshot({ path: 'delivery-order-form-inspection.png', fullPage: true });
