...
if ($completedSalesOrdersCount == 0) {
    ...
    // Manually trigger the observer since the update might not fire it in test context
    $observer = new \App\Observers\SaleOrderObserver();
    $observer->updated($saleOrder);

    echo "SALES ORDER COMPLETED - INVOICE SHOULD BE CREATED\n\n";
}
