...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .print-toolbar { display: flex; align-items: center; gap: .75rem; padding: .75rem 1.5rem; background: #14532d; color: #fff; position: sticky; top: 0; z-index: 100; }
        ...
        .pt-btn-print { background: #16a34a; color: #fff; }
...
<body>
    ...
    <div class="report-wrap fr-page">
        ...
        <div class="fr-body">
            ...
            @php $cogs = $data['revenue'] - $data['gross_profit']; @endphp
            <div class="fr-line">
            ...
            @php $totalOpEx = max(0, $data['gross_profit'] - $data['operating_profit']); @endphp
            <div class="fr-line">
