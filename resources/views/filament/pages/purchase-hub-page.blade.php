...
@php
    ...
    $sections = [
        [
            ...
            'items' => [
                ['label' => 'Permintaan Pembelian',      'url' => \App\Filament\Resources\OrderRequestResource::getUrl(),          'icon' => 'document-text',    'desc' => 'Ajukan permintaan bahan/barang ke supplier', 'class' => \App\Filament\Resources\OrderRequestResource::class],
                ['label' => 'Pesanan Pembelian',          'url' => \App\Filament\Resources\PurchaseOrderResource::getUrl(),         'icon' => 'shopping-cart',    'desc' => 'Buat & kelola purchase order ke vendor', 'class' => \App\Filament\Resources\PurchaseOrderResource::class],
                ['label' => 'Kontrol Kualitas Pembelian', 'url' => \App\Filament\Resources\QualityControlPurchaseResource::getUrl(),'icon' => 'beaker',           'desc' => 'Inspeksi kualitas barang yang diterima', 'class' => \App\Filament\Resources\QualityControlPurchaseResource::class],
                ['label' => 'Penerimaan Pembelian',       'url' => \App\Filament\Resources\PurchaseReceiptResource::getUrl(),       'icon' => 'inbox-arrow-down', 'desc' => 'Konfirmasi penerimaan barang dari supplier', 'class' => \App\Filament\Resources\PurchaseReceiptResource::class],
                ['label' => 'Retur Pembelian',            'url' => \App\Filament\Resources\PurchaseReturnResource::getUrl(),        'icon' => 'arrow-uturn-left', 'desc' => 'Kembalikan barang tidak sesuai ke supplier', 'class' => \App\Filament\Resources\PurchaseReturnResource::class],
            ],
        ],
        [
