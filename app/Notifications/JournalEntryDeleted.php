...
class JournalEntryDeleted extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->line('Journal entry has been deleted.')
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            'format' => 'filament',
            'title' => sprintf('Journal Entry Deleted: %s', $this->journalEntry->reference ?? $this->journalEntry->id),
