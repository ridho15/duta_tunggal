...
class JournalEntryUpdated extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->line('Journal entry has been updated.')
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            'format' => 'filament',
            'title' => sprintf('Journal Entry Updated: %s', $this->journalEntry->reference ?? $this->journalEntry->id),
