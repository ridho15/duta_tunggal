...
class BillOfMaterialPolicy
{
    ...
    {
        return $user->hasPermissionTo('view any bill of material');
    }
    ...
    {
        return $user->hasPermissionTo('view bill of material');
    }
    ...
    {
        return $user->hasPermissionTo('create bill of material');
    }
    ...
    {
        return $user->hasPermissionTo('update bill of material');
    }
    ...
    {
        return $user->hasPermissionTo('delete bill of material');
    }
    ...
    {
        return $user->hasPermissionTo('restore bill of material');
    }
    ...
    {
        return $user->hasPermissionTo('force-delete bill of material');
    }
}
